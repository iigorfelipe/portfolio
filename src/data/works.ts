...
export const works: Works[] = [
    ...
    media: [
      {
        viewMode: 'mobile',
        path: 'https://github.com/user-attachments/assets/eb31140e-db4c-42c6-9fc4-eb7f842b7225',
        alt: 'img'
      },
      {
        viewMode: 'mobile',
        path: 'https://github.com/user-attachments/assets/b1c21677-88a8-43b8-b24b-f5da4aca3d5f',
        alt: 'gif'
      },      
    ],
